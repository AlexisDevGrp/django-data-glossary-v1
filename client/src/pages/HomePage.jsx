					...
					<div className="d-flex justify-content-center">
						<div className="text-center">
							<h1 className="mx-auto my-0 text-uppercase">
								Clearstream Data Layer Glossary
							</h1>
							<h2 className="text-white-50 mx-auto mt-2 mb-5">
								The Central access to all Clearstream data Information sitting in the Clearstream Data Layer Cloud.
								Feel free to visit and contact us!
							</h2>
